...
export default function App() {
  ...
  const stablePlaybackTime = playerState.isPlaying
    ? Number(lastPlaybackCommitRef.current?.currentTime || playerState.currentTime || 0)
    : Number(playerState.currentTime || 0);
